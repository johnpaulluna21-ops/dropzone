...
export default function UploadWorkspace() {
  ...
  return (
    <div>
      ...
      >
        <input
          id="fileInputDashboard" type="file" multiple hidden
      ...
      {hasDuplicates && (
        <div style={{
          ...
          <p style={{ fontSize: 12, color: "#fcd34d" }}>
            ⚠️ {duplicates.length} duplicate file{duplicates.length > 1 ? "s" : ""} detected
          </p>
          <button
      ...
      {files.length > 0 && (
        <div style={{
          ...
          marginBottom: "1.25rem", maxHeight: 240, overflowY: "auto",
        }}>
          {files.map((file, i) => {
            ...
            return (
              <div key={i} style={{
                ...
                padding: "10px 12px",
                background: isDup ? "rgba(245,158,11,0.06)" : "rgba(255,255,255,0.04)",
                borderRadius: 12,
                border: `0.5px solid ${isDup ? "rgba(245,158,11,0.2)" : "rgba(255,255,255,0.07)"}`,
              }}>
                <div style={{
      ...
      {files.length > 0 && !selectedClientId && clients.length > 1 && (
        <div style={{
          ...
          <p style={{ fontSize: 12, color: "rgba(239,68,68,0.8)" }}>
            ⚠️ Please select a client before uploading
          </p>
        </div>
      )}
