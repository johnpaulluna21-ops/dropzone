    ...
    <>
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .signup-btn:hover:not(:disabled) { background: linear-gradient(135deg, #4f46e5, #7c3aed) !important; transform: translateY(-1px); }
      ...
      <main style={{
        ...
        backgroundImage: `
          ...
          radial-gradient(ellipse at 20% 80%, rgba(20,184,166,0.06) 0%, transparent 50%)
        `,
        display: "flex",
        alignItems: "center",
        justifyContent: "center",
          ...
          <div style={{
            ...
            <div style={{ marginBottom: "1.75rem" }}>
              ...
              <p style={{ fontSize: 13, color: "rgba(255,255,255,0.35)", lineHeight: 1.5 }}>
                Start organizing your tax documents today
              </p>
            </div>
