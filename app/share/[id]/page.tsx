      ...
      <div className="max-w-xl w-full bg-white rounded-2xl shadow-lg p-10 flex flex-col gap-6">
        ...
        {loading ? (
          ...
          <>
              ...
              {files.map((file) => (
                ...
                >
                  <div className="flex flex-col">
                    ...
                    <span className="text-gray-400 text-sm">{(file.filesize / 1024).toFixed(1)} KB</span>
                  </div>
            ...
            <button
              onClick={downloadAll}
              className="w-full bg-blue-600 text-white rounded-xl py-3 font-semibold hover:bg-blue-700 transition-all"
            >
