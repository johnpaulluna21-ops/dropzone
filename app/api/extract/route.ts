  ...
  try {
    ...
    if (use2307Prompt && extractedData && !extractedData.parse_error) {
      ...
      const normalized = mapFrom2307({
        ...
        month_1_income: extractedData.month_1_income ?? undefined,
        month_2_income: extractedData.month_2_income ?? undefined,
        month_3_income: extractedData.month_3_income ?? undefined,
        month_1_tax: extractedData.month_1_tax ?? undefined,
        month_2_tax: extractedData.month_2_tax ?? undefined,
        month_3_tax: extractedData.month_3_tax ?? undefined,
        atc: extractedData.atc || null,
